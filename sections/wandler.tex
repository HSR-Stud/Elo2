...
\begin{tabular}{|p{5.5cm}|c|c|} %>{\bfseries}p{0.25\textwidth}|c|c|}
	...
	& \parbox[c][6cm]{0.31\textwidth}{\includegraphics[height=5cm]{./images/idealerADC.jpg}}
	& \parbox[c]{0.31\textwidth}{\includegraphics[width=0.3\textwidth]{./images/idealerDAC.png}}
	\\ \hline
