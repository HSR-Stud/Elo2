...
\begin{tabular}{|>{\bfseries}p{0.31\textwidth}|c|c|}
	...
	& \includegraphics[height=3.5cm, valign=t]{./pictures/verstaerkungsfehlerADC.png} 
    & \includegraphics[height=3.5cm, valign=t]{./pictures/verstaerkungsfehlerDAC.png}
	\\ \hline
	Differentielle Nichtlinearität DNL \hartl{437}
	& \includegraphics[height=4cm, valign=t]{./pictures/DNL_ADC.png}
	& \includegraphics[height=4cm, valign=t]{./pictures/DNL_DAC.png}
	\\ \hline
