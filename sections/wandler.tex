...
\begin{tabular}{|p{5.5cm}|c|c|} %>{\bfseries}p{0.25\textwidth}|c|c|}
	...
	& \parbox[c][6cm]{0.31\textwidth}{\includegraphics[height=5cm]{./pictures/idealerADC.jpg}}
	& \parbox[c]{0.31\textwidth}{\includegraphics[width=0.3\textwidth]{./pictures/idealerDAC.png}}
	\\ \hline
...
\begin{minipage}{4cm}
  ...
  \includegraphics[scale=0.38]{pictures/aperturfehlercos}

\end{minipage}
&
\begin{minipage}{3cm}

  \includegraphics[scale=0.42]{pictures/aperturfehler}
\end{minipage}
&
\begin{minipage}{5cm}
\begin{gather*}
