...
\begin{longtable}{|>{\bfseries}p{3cm}|c|p{7.6cm}|}
	\hline
	Strom-DAC\hartl{456}  
	& \raisebox{-.2\totalheight}{\includegraphics[width=7cm, valign=t]{pictures/Strom-DAC}}
	& {\begin{align*}
	...
	& \raisebox{-.1\totalheight}{\includegraphics[width=5.5cm, valign=t]{pictures/string_DAC}}
	& 
		\begin{description}
	...
	& \raisebox{-.1\totalheight}{\includegraphics[width=5.6cm, height = 4cm, valign=t]{pictures/segmented_string_DAC}}
	& \begin{description}
