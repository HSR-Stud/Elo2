...
\begin{longtable}[t]{|p{4cm}|p{6.5cm}|p{7cm}|}
    ...
    \\ \hdashline
    \includegraphics[width=4cm, valign=t]{images/widerstandrauschen.png}
    & {	\vspace{-1.8\topsep}
        \begin{align*}
...
\vspace*{-0.5cm}\begin{longtable}[t]{|p{4cm}|p{5.2cm}|p{7cm}|}    
    ...
    \\ \hdashline
    \includegraphics[width=4cm, valign=t]{images/RauschenSpannungsteiler.png}
    & {\begin{align*}
    ...
    \\ \hdashline
    \includegraphics[width=2.8cm, valign=t]{images/seriewiderstand1.png}\newline
    \includegraphics[width=2.5cm]{images/seriewiderstand2.png}
...
\begin{longtable}[t]{|p{4cm}|p{8cm}|p{5.3cm}|}
    ...
    \\ \hdashline
    \includegraphics[width=4cm, valign=t]{images/RauschenTiefpass.png}
    & {\vspace{-1.5\topsep}
        \begin{align*}
...
\begin{longtable}[t]{|p{4cm}|p{13.8cm}|}
    ...
    \\ \hdashline
    \includegraphics[width=4cm, valign=t]{images/NoiseCornerFreq.png}\newline \vspace{0.5cm}\newline
    \includegraphics[width=4cm]{images/opampnoise.png} \newline \vspace{0.5cm} \newline
    \includegraphics[width=4cm]{images/RauschenSummierer}
