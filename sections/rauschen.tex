...
\begin{longtable}[t]{|p{4cm}|p{13.7cm}|}
    ...
    & {Bei $\mathrm{f_{nc}}$ kreuzt das 1/f-Rauschen mit dem weissen Rauschen\newline
       ...
       \begin{align*}
           E_{Trms}=&\sqrt{\int 4kTR_2\left( \frac{R_1+R_2}{R_1}\right) + 4kTR_3\left( \frac{R_1 + R_2}{R_1}\right) ^2 + ((i_{nn})R_2)^2 + ...}\\
           &\overline{...\left( (i_{np})R_3\left( \frac{R_1+R_2}{R_1}\right) \right) ^2 + \left( e_n\left( \frac{R_1+R_2}{R_1}\right) \right) ^2 df}
       \end{align*}
       \newline
       ...
       \begin{itemize}[leftmargin=*]
           ...
           \item $f_{enc}$: noise corner frequency (aus Datenblatt)
           \item \textcolor{red}{ENB}: Effective Noise Bandwidth
           \newline
        \end{itemize}
       $E_{Trms}=\sqrt{\textcolor{red}{ENB} \cdot 4kTR_2 A+e_w^2 A^2(f_{enc}\ln{\frac{f_{H}}{f_{L}}}+\textcolor{red}{ENB})}$\newline
