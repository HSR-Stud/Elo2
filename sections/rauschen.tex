...
% ----------------------------------------------------------------------------------------------------       
    ...
    & { \vspace{-1.5\topsep}
        \begin{align*}
            ...
            \overline{v_{n}} &=\sqrt{\overline{v^2_{n}}} = \sqrt{\overline{i_n^2} \cdot \int_{0}^{\infty}|\underline{Z}|^2d\omega}\\ &=\sqrt{\frac{4kTG}{2\pi}\int^{\infty}_{0}\frac{1}{G^2+\omega^2C^2}d\omega}\\
            &=\sqrt{\frac{kT}{C}}            
        \end{align*}
      }
    & {\vspace{-1.5\topsep}
