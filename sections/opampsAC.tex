...
\begin{tabular}{|p{0.45\linewidth}|p{0.45\linewidth}|}
    ...
    \vspace{-7mm}
	\begin{center}
	 	\includegraphics[height=2cm, valign=t]{./images/opAmpOL.png}
	\end{center}
		& \vspace{-7mm}
          \begin{center}
			\includegraphics[height=2cm, valign=t]{./images/opAmpCL.png}
		  \end{center}\\
	\hline
...
\includegraphics[width=0.7\textwidth, valign=t]{./images/AolAcl.png}
...
\subsection{Stabilität des Systems}
    ...
    Die UTF ist dann stabil, wenn sie nie $\infty$ wird d.h der Nenner darf nie 0 werden.
     \begin{center}
        \includegraphics[width=4cm, valign=t]{images/margins.png}
    \end{center}
