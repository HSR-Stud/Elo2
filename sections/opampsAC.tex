...
\begin{longtable}[t]{|p{5cm}|p{12.7cm}|}
    ...
    \\ \hdashline
    \includegraphics[width=5cm, valign=t]{pictures/opAmpBlock.png}\newline\newline
    ...
    & {\vspace{-1.5\topsep}
        \begin{align*}
            ...
            A &= A_{ol}\\
            \frac{V_{out}}{V_{in}} &= \textcolor{red}{T = \frac{T_{in}}{\beta}\cdot \frac{1}{1+ \frac{1}{\beta \cdot A_{ol}}} = \frac{T_{in}\cdot A_{ol}}{1 + A_{ol}\cdot \beta}} = \frac{1\cdot A_{ol}}{1 + A_{ol} \cdot \frac{R_1}{R_1 + R_f}} \approx \frac{R_1 + R_f}{R_1} =1 + \frac{R_f}{R_1}
        \end{align*}
    }
    \\ \hline
% ---------------------------------------------------------------------------------------------------- 
    ...
    & {\vspace{-1.5\topsep}
        \begin{align*}
            ...
            \beta &= \frac{R_1}{R_1 + R_f}\\
            A &= A_{ol}\\
            \frac{V_{out}}{V_{in}} &= \textcolor{red}{T = -\frac{T_{in}}{\beta}\cdot \frac{1}{1+ \frac{1}{\beta \cdot A_{ol}}}} \approx -\frac{R_f}{R_1}
        \end{align*}
    }
    \\ \hline
\end{longtable}
...
\begin{longtable}[t]{|p{5cm}|p{12.7cm}|}
    ...
    & {\vspace{-1.5\topsep}
        \begin{align*}
            ...
            \intertext{ergibt:}
            A_{cl}(s) &= \frac{\frac{A_0}{1 + s/\omega_p}}{1 + \beta \frac{A_0}{1 + s/\omega_p}} = \frac{A_0}{(1 + A_0 \beta) + s/\omega_p} = \frac{\textcolor{red}{\frac{A_0}{1 + A_0 \beta}}}{1 + s \frac{1}{\textcolor{blue}{\omega_p(1 + A_0 \beta)}}} = \frac{\textcolor{red}{A_{0_{cl}}}}{1 + s\frac{1}{\textcolor{blue}{\omega_{p_{cl}}}}}
        \end{align*}
        \newline
